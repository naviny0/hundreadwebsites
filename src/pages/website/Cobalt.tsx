...
function Cobalt() {
  return (
    <div className="h-screen text-white bg-zinc-950 antialiased selection:bg-cyan-300 selection:text-cyan-800">
...
function Navbar() {
  return (
    <div className="flex items-center justify-between max-w-6xl mx-auto py-8">
      <SvgCobalt />
      <div>
        <ul className="flex items-center gap-10">
          <li>Blog</li>
          <li>
            <button className="border-neutral-700 px-4 py-2 border rounded-xl relative">
              Join the waitlist
              <div className="absolute bg-linear-to-r from-transparent via-cobalt-blue to-transparent h-px inset-x-0 -bottom-px w-full "></div>
            </button></li>
        </ul>
      </div>
    </div>
...
function Hero() {
  return (
    <div className="max-w-6xl mx-auto text-center">
      <h1 className="pt-20 text-7xl font-bold w-3xl bg-linear-to-b bg-clip-text text-transparent leading-20 mx-auto from-neutral-50 to-neutral-500">
        Unleash the power of intuitive finance
      </h1>
      <p className="w-2xl my-10 mx-auto text-lg text-gray-400 font-semibold">
        Say goodbye to the outdated financial tools. Every small business owner, regardless of the background, can now manage their business like a pro. <br /> Simple. Intuitive. And never boring.
      </p>
